...
//判断字符串是否为空
#define isTSEmptyString(str) ([str isKindOfClass:[NSNull class]] || str == nil || ![str isKindOfClass:[NSString class]] || [str length] < 1)

//判断数组是否为空
#define isTSEmptyArray(array) (array == nil || [array isKindOfClass:[NSNull class]] || ![array isKindOfClass:[NSArray class]] || (array.count == 0))
//判断字典是否为空
#define isTSEmptyDict(dic) (dic == nil || [dic isKindOfClass:[NSNull class]] || ![dic isKindOfClass:[NSDictionary class]] || (dic.allKeys == 0))
